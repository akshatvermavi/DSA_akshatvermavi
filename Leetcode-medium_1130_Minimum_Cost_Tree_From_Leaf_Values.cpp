// class Solution {
// public:
//     int solveusingrr(vector<int>& arr,map<pair<int,int>,int>& maxi, int left, int right){
//         int ans = INT_MAX;
//         if(left==right)
//             return ans;
...
//             + solveusingrr(arr, maxi,left,i)
//             +  solveusingrr(arr, maxi,i+1,right));
//         }
//         return ans;
//     }
...
//        int ans = solveusingrr(arr, maxi,0,n-1);
//        return ans; 
//     }
// };
